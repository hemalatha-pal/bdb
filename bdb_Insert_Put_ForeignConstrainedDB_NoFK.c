/* BDB code to show how we get Foreign key constraint error since Foreign key is not present in Foreign DB,
So insert into Primary key DB fails with Foreign key constraint error */
